/**
 * migrate-mongo configuration for Event Service
 * 
 * Usage:
...
const config = {
  mongodb: {
    url: process.env.MONGODB_URI || 'mongodb://event_user:event_password@localhost:27017/event_service_db?authSource=event_service_db',
